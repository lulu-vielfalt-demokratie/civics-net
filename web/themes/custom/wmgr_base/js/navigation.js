...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape') {
        if (props.wmgr_base.areAnySubNavsOpen()) {
          props.wmgr_base.closeAllSubNav();
        } else {
    ...
    window.addEventListener('resize', () => {
      if (props.wmgr_base.isDesktopNav()) {
        toggleNav(props, false);
      ...
      Drupal.wmgr_base.closeAllSubNav();
    });
   ...
   */
  Drupal.behaviors.wmgr_baseNavigation = {
    attach(context) {
