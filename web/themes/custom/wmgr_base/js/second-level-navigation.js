...
((Drupal) => {
  const { isDesktopNav } = Drupal.wmgr_base;
  ...
  Drupal.wmgr_base.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.wmgr_base.isDesktopNav()) return;
  ...
  Drupal.wmgr_base.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.wmgr_base.areAnySubNavsOpen = areAnySubNavsOpen;
  ...
  function init(navElement) {
    ...
    once('wmgr_base-second-level-nav-document', document).forEach(() => {
