...
namespace Drupal\wmgr_base\Hook;

use Drupal\Core\Template\Attribute;
use Drupal\wmgr_base\OliveroPreRender;
...
/**
 * Hook implementations for wmgr_base.
 */
class OliveroHooks {
  ...
  public function preprocessMaintenancePage(array &$variables): void {
    ...
    $variables['#attached']['library'][] = 'wmgr_base/maintenance-page';
  }
  ...
  public function preprocessNode(array &$variables): void {
    ...
    if (!empty($variables['date']) && !empty($variables['display_submitted']) && $variables['display_submitted'] === TRUE) {
      $variables['date'] = \Drupal::service('date.formatter')->format($variables['node']->getCreatedTime(), 'wmgr_base_medium');
    }
  ...
  public function preprocessField(array &$variables): void {
    ...
    if (in_array($variables['field_type'], $rich_field_types, TRUE)) {
      ...
      $variables['#attached']['library'][] = 'wmgr_base/wmgr_base.table';
    }
  ...
  public function preprocessSearchResult(array &$variables): void {
    ...
    if (!empty($variables['result']['date'])) {
      $variables['info_date'] = \Drupal::service('date.formatter')->format($variables['result']['node']->getCreatedTime(), 'wmgr_base_medium');
    }
  }
  ...
  public function preprocessItemListSearchResults(array &$variables): void {
    if (isset($variables['empty'])) {
      ...
      $variables['empty']['#attached']['library'][] = 'wmgr_base/search-results';
    }
  }
