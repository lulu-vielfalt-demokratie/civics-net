...
/**
 * Page preprocess hooks for wmgr_base.
 */
class OliveroPagePreprocessHooks {
  ...
  public function preprocessHtml(array &$variables): void {
    ...
    [$h, $s, $l] = _wmgr_base_hex_to_hsl($brand_color_hex);
    ...
    // a subtheme.
    $variables['wmgr_base_path'] = $this->requestStack->getCurrentRequest()->getBasePath() . '/' . $this->themeExtensionList->getPath('wmgr_base');
