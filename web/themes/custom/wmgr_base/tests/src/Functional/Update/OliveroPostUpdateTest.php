...
namespace Drupal\Tests\wmgr_base\Functional\Update;
...
#[CoversFunction('wmgr_base_post_update_remove_shortcut_settings_if_not_installed')]
class OliveroPostUpdateTest extends UpdatePathTestBase {
  ...
  /**
   * Tests update wmgr_base third party settings without shortcut installed.
   */
  public function testOliveroThirdPartySettingsWithoutShortcut(): void {
    $config = $this->config('wmgr_base.settings');
