...
namespace Drupal\Tests\wmgr_base\Unit;
...
/**
 * Tests the _wmgr_base_hex_to_hsl() function.
 */
#[Group('wmgr_base')]
final class OliveroHexToHslTest extends UnitTestCase {
  ...
  public function setUp(): void {
    parent::setUp();
    require_once __DIR__ . '/../../../wmgr_base.theme';
  }
  ...
  public function testHexToHsl(string $hex, array $expected_hsl): void {
    self::assertEquals($expected_hsl, _wmgr_base_hex_to_hsl($hex));
  }
